...
const INITIAL_EVENT = {
  ...
  date: "Day 2 · September 10, 2026",
  code: "PLR-0910",
};
const EVENT_SECOND_DAY = {
  sport: "VolleyBall",
  venue: "Grand Stand",
  schedule: "10:00 AM - 12:00 PM",
  date: "Day - 2 October 12,2026",
  code: "PALARO10022026",
};

const INITIAL_SECTIONS = [
  { id: "BSCS1A", name: "BSCS 1A", rep: "Juan Dela Cruz", expected: 40, present: 38 },
  { id: "BSIT1A", name: "BSIT 1A", rep: "Maria Santos", expected: 35, present: 31 },
  { id: "BSEMC1A", name: "BSEMC 1A", rep: "Pedro Reyes", expected: 42, present: 40 },
  { id: "BSCS1B", name: "BSCS 1B", rep: "Anna Lim", expected: 38, present: 33 },
  { id: "BSIT2A", name: "BSIT 2A", rep: "Mark Cruz", expected: 36, present: 36 },
  { id: "BSEMC2A", name: "BSEMC 2A", rep: "Liza Tan", expected: 34, present: 29 },
];

const DIRECTORY = [
  { id: "2026-12345", name: "Jhian Carlo A. Manacpo", section: "BSCS 1A", sport: "Basketball", password: "pass123" },
...
export default function App() {
  ...
  const [event, setEvent] = useState(EVENT_SECOND_DAY);
